...
public class Tunes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(Tunes.this,val,Toast.LENGTH_LONG).show();
    ...
    void display(){
        ...
        String abc="/"+"sdcard"+"/"+val+"/";
        MEDIA_PATH = new String(abc);
        File home = new File(MEDIA_PATH);

        final ArrayList<File> mySongs = findSong(home /*Environment.getExternalStorageDirectory()*/);
