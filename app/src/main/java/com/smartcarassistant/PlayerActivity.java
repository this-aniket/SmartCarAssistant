    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateSeekBar=new Thread(){
            ...
            public void run(){
                ...
                int runtime = mp.getDuration();   //extra changes
                ...
                while(currentPosition < totalDuration){
                    try{
                        ...
                        e.printStackTrace();
                    }catch (IllegalStateException e) {      //extra changes

                        //currentPosition=mp.getCurrentPosition();// doka
                        sb.setProgress(runtime);
                        sb.setProgress(currentPosition);// doka
